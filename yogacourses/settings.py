"""
Django settings for yogacourses project.
...
ALLOWED_HOSTS = ['rockyoga.uk', 'localhost']

if os.environ.get('GOOGLE_CLOUD_PROJECT', None):
    client = secretmanager.SecretManagerServiceClient()
    project_id = os.environ.get("GOOGLE_CLOUD_PROJECT")
    settings_name = os.environ.get("SETTINGS_NAME", "rockyoga")
...
TEMPLATES = [
    {
        ...
        # declare the name of the folder where the html will be sotrage
...
WSGI_APPLICATION = 'yogacourses.wsgi.application'
