...
class Category(models.Model):
    ...
    # Meta clase to update the string
    # values for the verbose name and it's plural
    class Meta:
    ...
    # The str method tells django wich field of the model display
    # when we need to create a instance of the category model.
    def __str__(self):
        return self.title
...
class Course(models.Model):
    ...
    # The str here represent a course object each time is called,
    # here will return course name.
    def __str__(self):
        return self.name
    ...
    # property to return all the sections of the course,
    # and sorted byt the section's position property.
    @property
    def sections(self):
...
class Section(models.Model):
    """In each section it will be a list of videos that
    ...
    # property to return a list of the sections of videos
    # and sort it by the section's Video's property.
    @property
    def videos(self):
...
# check if the course slug doen't exists and then vonvert the
# category title to the slug.
def pre_save_course(sender, instance, *args, **kwargs):
    if not instance.slug:
        instance.slug = slugify(instance.name)


# check if the section slug doen't exists and then vonvert
# the category title to the slug.
...
# check if the video slug doen't exists and then vonvert
#  the category title to the slug.
